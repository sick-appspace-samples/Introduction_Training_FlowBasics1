## Introduction_Training_FlowBasics1
How to utilize a data flow
...
The purpose of this one is to basically describe how to use a data flow.

### Topics
training, introduction, flow, data, sampleapp, sick-appspace
